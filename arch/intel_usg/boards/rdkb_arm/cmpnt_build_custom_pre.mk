...
CFLAGS += -DCONFIG_CISCO_HOTSPOT -DCONFIG_CISCO_HOME_SECURITY
INCPATH += $(SDK_PATH)/ti/gw/src
...
# ARRIS MOD for SDK 4.3. Intel libraries changed
...
LDFLAGS += -larris_rf_freqscan -larris_mta_db -larris_vqm -lkerb
LDFLAGS += -larris_rdkb_moca -lncsLog_db -larris_tlm
LDFLAGS += -larris_moca -lmoca_nvm -lclinkapi
